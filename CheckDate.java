...
public class CheckDate
{
    ...
    {
        System.out.println("Welcome to the Date checker.");
        System.out.println("Please enter a date to be checked in the following format mm/dd/yyyy");
        ...
        switch(month){
            case 2:  //February
                ...
                if(leapYear && day>29){
                    validDate = false;
                    message = "The day value is greater than 29 in February in a leep year. ";
                }
